...
<DialogContent>
<DialogHeader>
<DialogTitle>{isEdit ? "Kaydi Duzenle" : "Yeni Bagis / Sadaka"}</DialogTitle>
</DialogHeader>
<form action={handleSubmit} className="flex flex-col gap-4">
{donation && <input type="hidden" name="id" value={donation.id} />}
<div className="grid grid-cols-2 gap-3">
<div className="flex flex-col gap-1.5">
<Label htmlFor="donationType">Tur</Label>
...
placeholder="Orn. Kizilay, komsu Ahmet Bey, cami insaati..."
required
/>
</div>
<div className="flex flex-col gap-1.5">
...
Bu odeme zekat borcumdan dusulsun
</label>
