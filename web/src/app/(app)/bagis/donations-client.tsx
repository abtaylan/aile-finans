...
<div>
<h1 className="text-xl font-semibold text-[var(--text-primary)]">Bağış ve Sadaka</h1>
<p className="text-sm text-[var(--text-secondary)]">
Yapılan hayırların kime, ne zaman ve ne kadar verildiğinin kaydı.
</p>
</div>
<DonationDialog />
</div>
...
<Card className="p-4">
<p className="text-sm text-[var(--text-secondary)]">Toplam Bağış/Sadaka</p>
<p className="text-2xl font-semibold text-[var(--text-primary)]">
{formatCurrency(total)}
</p>
</Card>
<Card className="p-4">
<p className="text-sm text-[var(--text-secondary)]">Zekâttan Düşülen</p>
<p className="text-2xl font-semibold text-[var(--text-primary)]">
...
Henüz bağış/sadaka kaydı eklenmedi.
</p>
) : (
...
{d.counts_toward_zakat && <Badge>Zekât</Badge>}
</div>
</div>
