...
Banka hesaplarini, kredi kartlarini ve yatirim hesaplarini yonet.
</p>
</div>
...
<p className="text-sm text-[var(--text-secondary)]">
Henuz hic hesap eklenmedi. Baslamak icin &quot;Hesap Ekle&quot; butonuna tikla.
</p>
</Card>
) : (
...
<span>
Son Odeme: {formatDate(latestStatements[account.id].payment_due_date!)}
</span>
)}
</div>
) : (
<p className="text-xs text-[var(--text-muted)]">Henuz ekstre girilmedi.</p>
)}
