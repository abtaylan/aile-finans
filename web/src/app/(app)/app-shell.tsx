...
{ href: "/butce", label: "Butce", icon: PiggyBank },
{ href: "/portfoy", label: "Portfoy", icon: LineChart },
{ href: "/zekat", label: "Zekat", icon: HandCoins },
{ href: "/bagis", label: "Bagis", icon: HandHeart },
