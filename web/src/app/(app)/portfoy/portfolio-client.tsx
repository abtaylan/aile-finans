...
totalsByType.set(type, (totalsByType.get(type) ?? 0) + value);
}
return Array.from(totalsByType.entries())
.map(([type, value]) => ({ name: ASSET_TYPE_LABELS[type] ?? type, value }))
.sort((a, b) => b.value - a.value);
}, [holdings, assetById, latestPrices]);
...
{isTcmbPriced && <Badge variant="secondary">TCMB satış kuru</Badge>}
</div>
