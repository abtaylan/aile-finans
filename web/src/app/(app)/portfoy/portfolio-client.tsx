...
const tcmbSet = useMemo(() => new Set(tcmbAssetIds), [tcmbAssetIds]);
...
() =>
[...holdings].sort((a, b) => {
const priceA = latestPrices[a.asset_id] ?? a.average_unit_cost;
const priceB = latestPrices[b.asset_id] ?? b.average_unit_cost;
...
<div>
<h1 className="text-xl font-semibold text-[var(--text-primary)]">Portfoy</h1>
<p className="text-sm text-[var(--text-secondary)]">
Altin, doviz ve fon pozisyonlarini lot bazinda takip et.
</p>
</div>
...
<Card>
<CardHeader>
<CardTitle>Guncel Piyasa Degeri</CardTitle>
</CardHeader>
<CardContent className="pt-0">
<p className="text-2xl font-semibold text-[var(--text-primary)]">
...
<p className="text-sm text-[var(--text-secondary)]">
Henuz bir alim yapilmadi. &quot;Alim Ekle&quot; ile ilk lotunu ekle.
</p>
</Card>
) : (
<div className="flex flex-col gap-4">
...
const isTcmbPriced = tcmbSet.has(h.asset_id);
...
{isTcmbPriced && <Badge variant="secondary">TCMB satis kuru</Badge>}
</div>
...
<th className="pb-1.5 font-medium">Islem</th>
...
>
{t.transaction_type === "buy" ? "Alim" : "Satim"}
</span>
</td>
